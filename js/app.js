...
async function showNuisancesAt(lon, lat) {
  ...
  const rows=[
    ...
    {name:"Artificialisation",score:artificialScore,value:artificial==null?"Lecture indisponible":`${fmt(artificial.share*100)} % de sols bâtis ou minéraux autour du point`,why:artificial?`La note mesure la part réellement bâtie ou minérale dans un disque de 200 m. Les jardins, pelouses, boisements et autres couvertures végétales restent non minéralisés. Au point exact, la couverture est ${artificial.atPoint?"bâtie ou minérale":"végétalisée ou naturelle"}.`:"Lecture locale indisponible.",detail:"0 % = 0/5 · 100 % = 5/5 · disque de 200 m",source:"OCS GE IGN · couverture du sol 2024-2026"},
