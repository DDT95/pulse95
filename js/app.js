...
async function showNuisancesAt(lon, lat) {
  ...
  const rows=[
    ...
    {name:"Artificialisation",score:artificialScore,value:artificial==null?"Lecture indisponible":`${fmt(artificial.share*100)} % de sols bâtis ou minéraux autour du point`,why:artificial?`La mesure conserve toute la part bâtie ou minérale observée dans le disque de 200 m. Sa contribution au stress reste secondaire : 2 × part², avec un maximum de 2/5. Les jardins, pelouses, boisements et autres couvertures végétales restent non minéralisés. Au point exact, la couverture est ${artificial.atPoint?"bâtie ou minérale":"végétalisée ou naturelle"}.`:"Lecture locale indisponible.",detail:"Contribution = 2 × part minéralisée² · plafond 2/5 · disque de 200 m",source:"OCS GE IGN · couverture du sol 2024-2026"},
